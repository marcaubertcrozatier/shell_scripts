...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_32TR2x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/32TR2xOCM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-*|sort -t"-" -k 7,7|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 32TR2x New OCM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/32tocmref.in > /home/nsuser/shell/32tocmref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/32tocmref.txt
