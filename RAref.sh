...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/RA_platform_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/builds/build/CBS3RAPLA
export REF=/space/nsuser/p4client/cbs3/RA/swf/apps
export P4CLIENT=RAb2c_fan
...
export RECIP2="Marc.Aubert@comverse.com,Matthieu.Nguyen@comverse.com,Mark.Young@comverse.com,Harry.Schonberger@comverse.com,Linan.Su@comverse.com,Hua.Liu@comverse.com,Kenneth.Tang@comverse.com,Eddie.Cen@comverse.com,Wendy.Guo@comverse.com,Canh.Tran@comverse.com,Ken.Chan@comverse.com"
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-RA-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-RA-*|tail -1`
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_RAref.in|awk '{print $2}'`
...
echo "Envoi du mail"
echo
subject="Nouvelle reference RAPLATFORM : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/RAref.in > /home/nsuser/shell/RAref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/RAref.txt
...
echo "Envoi du mail"
echo
subject="New RA PLATFORM reference : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/RAref2.in > /home/nsuser/shell/RAref2.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/RAref2.txt
############################
