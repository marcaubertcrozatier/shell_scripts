...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe22_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE22PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe22*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe22-*|sort -n -t"-" -k 6,6|tail -1`
...
< /home/nsuser/shell/zanbe22ref.in > /home/nsuser/shell/zanbe22ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe22ref.txt
