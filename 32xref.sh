...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_32x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/32xPLATFORM
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 32x New PLATFORM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/32xref.in > /home/nsuser/shell/32xref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/32xref.txt
