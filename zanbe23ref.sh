...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe23_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE23PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe23*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe23-*|sort -n -t"-" -k 6,6|tail -1`
...
< /home/nsuser/shell/zanbe23ref.in > /home/nsuser/shell/zanbe23ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe23ref.txt
