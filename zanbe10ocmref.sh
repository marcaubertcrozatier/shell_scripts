...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_zanbe10_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE10OCM
export REF=/space/nsuser/p4client/zanbe10/swf/css-apps
export P4CLIENT=zanbe10apps_zan
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-zanbe10*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-zanbe10*|sort -n -t"-" -k 7,7|tail -1`
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_zanbe10ref.in|awk '{print $2}'`
...
sed -e "s/!NUM_REF!/$num_ref/" \
    -e "s/!VERSION!/$version/" \
< /home/nsuser/shell/zanbe10ocmref.in > /home/nsuser/shell/zanbe10ocmref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe10ocmref.txt
