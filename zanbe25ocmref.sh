...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_zanbe25_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE25OCM
export REF=/space/nsuser/p4client/zanbe25/swf/css-apps
export P4CLIENT=zanbe25apps_zan
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-zanbe25*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-zanbe25*|sort -n -t"-" -k 6,6|tail -1`
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_zanbe25ref.in|awk '{print $2}'`
...
sed -e "s/!NUM_REF!/$num_ref/" \
    -e "s/!VERSION!/$version/" \
< /home/nsuser/shell/zanbe25ocmref.in > /home/nsuser/shell/zanbe25ocmref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe25ocmref.txt
