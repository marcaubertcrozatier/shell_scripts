...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_32x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/32xOCM
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 32x New OCM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/32xocmref.in > /home/nsuser/shell/32xocmref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/32xocmref.txt
