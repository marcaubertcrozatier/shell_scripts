...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe6_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE6PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe6*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe6-*|sort -n -t"-" -k 6,6|tail -1`
...
< /home/nsuser/shell/zanbe6ref.in > /home/nsuser/shell/zanbe6ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe6ref.txt
