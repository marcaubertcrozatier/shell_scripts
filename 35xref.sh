...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_35x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/35xPLATFORM
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 35x New PLATFORM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/35xref.in > /home/nsuser/shell/35xref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/35xref.txt
