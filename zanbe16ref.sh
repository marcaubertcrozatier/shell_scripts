...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe16_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE16PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe16*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe16-*|sort -n -t"-" -k 7,7|tail -1`
...
< /home/nsuser/shell/zanbe16ref.in > /home/nsuser/shell/zanbe16ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe16ref.txt
