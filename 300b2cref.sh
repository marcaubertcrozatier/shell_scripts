...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/300_b2c_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/CBS33.0.0APPS/myshapeb2c
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-consumer-GA2-*|sort -n -t"-" -k 7,7|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-consumer-GA2-*|sort -n -t"-" -k 7,7|tail -1`
...
echo "Envoi du mail"
echo
subject="Nouvelle reference GA2B2C : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/300refb2c.in > /home/nsuser/shell/300refb2c.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/300refb2c.txt
...
echo "Envoi du mail"
echo
subject="New GA2 B2C reference : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/300ref2b2c.in > /home/nsuser/shell/300ref2b2c.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/300ref2b2c.txt
############################
