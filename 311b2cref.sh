...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/311_b2c_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/CBS33.0.15APPS/myshapeb2c
export REF=/space/nsuser/p4client/cbs3/3.0.11/swf/apps
export P4CLIENT=311b2c_fan
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_311ref.in|awk '{print $2}'`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] New GA3B2C reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/311refb2c.in > /home/nsuser/shell/311refb2c.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/311refb2c.txt
...
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/311ref2b2c.in > /home/nsuser/shell/311ref2b2c.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/311ref2b2c.txt
############################
