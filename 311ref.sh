...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/311_platform_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/builds/build/CBS33.0.15PLA
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-GA3-*|sort -n -t"-" -k 7,7|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-GA3-*|sort -n -t"-" -k 7,7|tail -1`
...
cd $REFDIR
cp -r ../build/CBS33.0.15PLA/$new_ref .
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] New GA3PLATFORM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/311ref.in > /home/nsuser/shell/311ref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/311ref.txt
...
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/311ref2.in > /home/nsuser/shell/311ref2.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/311ref2.txt
############################
