...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/301_platform_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/builds/build/CBS33.0.10PLA
...
cd $REFDIR
cp -r ../build/CBS33.0.10PLA/$new_ref .
...
echo "Envoi du mail"
echo
subject="Nouvelle reference GA3PLATFORM : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/301ref.in > /home/nsuser/shell/301ref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/301ref.txt
...
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/301ref2.in > /home/nsuser/shell/301ref2.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/301ref2.txt
############################
