...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_358_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/358OCM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-358-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-358-[0-9]*|sort -n -t"-" -k 7,7|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 3.5.80 New OCM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/358ocmref.in > /home/nsuser/shell/358ocmref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/358ocmref.txt
