...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe27_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE27PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe27*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe27-*|sort -n -t"-" -k 7,7|tail -1`
...
< /home/nsuser/shell/zanbe27ref.in > /home/nsuser/shell/zanbe27ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe27ref.txt
