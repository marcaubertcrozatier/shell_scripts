...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/b2c_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/CCBSAPPS/myshapeb2c
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-consumer-*|sort -n -t"-" -k 3,3|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-consumer-*|sort -n -t"-" -k 3,3|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] CCBS New B2C reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/refb2c.in > /home/nsuser/shell/refb2c.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/refb2c.txt
...
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/ref2b2c.in > /home/nsuser/shell/ref2b2c.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/ref2b2c.txt
############################
