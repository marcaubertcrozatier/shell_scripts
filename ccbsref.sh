...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/builds/build/CCBSPLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-*|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] CCBS New PLATFORM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/ref.in > /home/nsuser/shell/ref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/ref.txt
