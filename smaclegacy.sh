  ...
  do
                ...
                then
                        ...
                        then case $line in
						  ...
						  owner=""
						  echo "<TR BGCOLOR=F6F6F6><TD>$nb</TD><TD>$customer</TD><TD><CENTER>$sname1 $sname2</CENTER></TD><TD>$module</TD><TD>$id</TD><TD>$title</TD><TD>$severity</TD><TD BGCOLOR=$bgcolor>$priority</TD><TD>$owner</TD><TD>$state</TD><TD>$sdate</TD></TR>" >> $HOME/legacymail.txt
                             			  echo $id >> $HOME/.lastlegacybug2.txt
                             			  nb=`expr $nb + 1`;;
                                *)i=1;;
                             esac
                        fi
...
#			esac
                        ...
                        then i=7
			     link=`echo $LINK|sed -e "s/!DBID!/$dbid/"`
                             echo "<TR BGCOLOR=F6F6F6><TD>$nb</TD><TD>$customer</TD><TD><CENTER>$sname1 $sname2</CENTER></TD><TD>$module</TD><TD>$type</TD><TD><a href=$link>$id</a></TD><TD>$title</TD><TD>$severity</TD><TD BGCOLOR=$bgcolor>$priority</TD><TD>$owner</TD><TD>$state</TD><TD>$sdate</TD></TR>" >> $HOME/legacymail.txt
			     echo $id >> $HOME/.lastlegacybug2.txt
                             nb=`expr $nb + 1`
                        fi
                        if [ $i -lt 0 ]
