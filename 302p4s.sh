...
P4PASSWD=nsuser
export P4PASSWD
BUILDS=/home/jerusalem2/sf/cdimages/swf/milestones/302-DIT41-TR5
SRCROOT=//depot/cbs3/302
TMP=/tmp
HOME=/home/nsuser/shell
ROOTBUILDREP=/home/jerusalem2/sf/cdimages/swf/cdimages/build
SUBJECT="302-DIT4-TR5 build status"
...
do
	...
	case $comp in
		platform) comp2=platform
			  buildrep=$ROOTBUILDREP/CBS3302PLA;;
		ocm) comp2=ocm
		     buildrep=$ROOTBUILDREP/CBS3302OCM;;
		apps) comp2=consumer
		      buildrep=$ROOTBUILDREP/CBS3302APPS/myshapeb2c;;
		ik) comp2=is
		    buildrep=$ROOTBUILDREP/CBS3302APPS/ik;;
	esac
	cd $buildrep
