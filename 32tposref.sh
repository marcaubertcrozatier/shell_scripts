...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/pos_32TR2x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/32TR2xAPPS/myshapepos
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 32TR2x New CHANNEL reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/32tposref.in > /home/nsuser/shell/32tposref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/32tposref.txt
