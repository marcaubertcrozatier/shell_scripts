...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/b2c_35x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/35xAPPS/myshapeb2c
export REF=/space/nsuser/p4client/cbs3/3.5.x/swf/apps
export P4CLIENT=35xb2c_cha
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_35xref.in|awk '{print $2}'`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 35x New CONSUMER reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/35xb2cref.in > /home/nsuser/shell/35xb2cref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/35xb2cref.txt
