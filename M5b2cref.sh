...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/M5_b2c_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/CBS3M5APPS/myshapeb2c
...
export RECIP2="Marc.Aubert@comverse.com,Matthieu.Nguyen@comverse.com,Dmitry.Strelbytsky@comverse.com,Mark.Young@comverse.com,Jeanne.Tsui@comverse.com,Harry.Schonberger@comverse.com,John.Nguyen@comverse.com,Linan.Su@comverse.com,Hua.Liu@comverse.com,Kenneth.Tang@comverse.com,yu.mao@comverse.com,Eddie.Cen@comverse.com,Canh.Tran@comverse.com"
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-b2c-M5-*|sort -n -t"-" -k 3,3|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-b2c-M5-*|sort -n -t"-" -k 3,3|tail -1`
...
echo "Envoi du mail"
echo
subject="Nouvelle reference M5B2C : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/M5refb2c.in > /home/nsuser/shell/M5refb2c.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/M5refb2c.txt
...
echo "Envoi du mail"
echo
subject="New CCBSB2C reference : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/M5ref2b2c.in > /home/nsuser/shell/M5ref2b2c.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/M5ref2b2c.txt
############################
