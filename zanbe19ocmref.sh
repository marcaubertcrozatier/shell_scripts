...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_zanbe19_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE19OCM
export REF=/space/nsuser/p4client/zanbe19/swf/css-apps
export P4CLIENT=zanbe19apps_zan
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-zanbe19*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-zanbe19*|sort -n -t"-" -k 6,6|tail -1`
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_zanbe19ref.in|awk '{print $2}'`
...
sed -e "s/!NUM_REF!/$num_ref/" \
    -e "s/!VERSION!/$version/" \
< /home/nsuser/shell/zanbe19ocmref.in > /home/nsuser/shell/zanbe19ocmref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe19ocmref.txt
