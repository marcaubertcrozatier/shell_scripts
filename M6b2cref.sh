...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/M6_b2c_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/CBS3M6APPS/myshapeb2c
...
export RECIP2="Marc.Aubert@comverse.com,Matthieu.Nguyen@comverse.com,Dmitry.Strelbytsky@comverse.com,Mark.Young@comverse.com,Harry.Schonberger@comverse.com,John.Nguyen@comverse.com,Linan.Su@comverse.com,Hua.Liu@comverse.com,Kenneth.Tang@comverse.com,Eddie.Cen@comverse.com,Canh.Tran@comverse.com"
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-consumer-M6-*|sort -n -t"-" -k 3,3|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-consumer-M6-*|sort -n -t"-" -k 3,3|tail -1`
...
echo "Envoi du mail"
echo
subject="Nouvelle reference M6B2C : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/M6refb2c.in > /home/nsuser/shell/M6refb2c.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/M6refb2c.txt
...
echo "Envoi du mail"
echo
subject="New M6 B2C reference : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/M6ref2b2c.in > /home/nsuser/shell/M6ref2b2c.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/M6ref2b2c.txt
############################
