...
P4PASSWD=nsuser
export P4PASSWD
BUILDS=/home/jerusalem2/sf/cdimages/swf/milestones/oldies/GA3-3.0.15-1.3
#SRCROOT=//depot/c-one
SRCROOT=//depot/ccbs
...
cd $BUILDS
#
for comp in platform ocm b2c pos ik
do
	if [ -f $TMP/$comp.txt ]
	...
	case $comp in
		...
		pos) comp2=channel
		      buildrep=$ROOTBUILDREP/CCBSAPPS/myshapepos;;
		ik) comp2=is
