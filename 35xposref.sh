...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/pos_35x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/35xAPPS/myshapepos
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 35x New CHANNEL reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/35xposref.in > /home/nsuser/shell/35xposref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/35xposref.txt
