...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe34_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE34PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe34*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe34-*|sort -n -t"-" -k 6,6|tail -1`
...
< /home/nsuser/shell/zanbe34ref.in > /home/nsuser/shell/zanbe34ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe34ref.txt
