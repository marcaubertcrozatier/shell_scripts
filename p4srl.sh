...
do
	...
	case $comp in
		platform) comp2=platform
			  buildrep=$ROOTBUILDREP/CBS3M6PLA;;
		ocm) comp2=ocm
		     buildrep=$ROOTBUILDREP/CBS3M6OCM;;
		apps) comp2=consumer
		      buildrep=$ROOTBUILDREP/CBS3M6APPS/myshapeb2c;;
		ik) comp2=is
		    buildrep=$ROOTBUILDREP/CBS3M6APPS/ik;;
	esac
	cd $buildrep
