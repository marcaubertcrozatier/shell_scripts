...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe3_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE3PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe3*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe3-*|sort -n -t"-" -k 7,7|tail -1`
...
< /home/nsuser/shell/zanbe3ref.in > /home/nsuser/shell/zanbe3ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe3ref.txt
