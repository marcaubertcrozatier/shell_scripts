...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_zanbe1_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE1OCM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-zanbe1-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-zanbe1-[0-9]*|sort -n -t"-" -k 7,7|tail -1`
...
sed -e "s/!NUM_REF!/$num_ref/" \
    -e "s/!VERSION!/$version/" \
< /home/nsuser/shell/zanbe1ocmref.in > /home/nsuser/shell/zanbe1ocmref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe1ocmref.txt
