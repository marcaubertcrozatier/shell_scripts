...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe2_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE2PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe2*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe2-*|sort -n -t"-" -k 7,7|tail -1`
...
< /home/nsuser/shell/zanbe2ref.in > /home/nsuser/shell/zanbe2ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe2ref.txt
