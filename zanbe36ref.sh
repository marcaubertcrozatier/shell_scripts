...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe36_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE36PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe36*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe36-*|sort -n -t"-" -k 7,7|tail -1`
...
< /home/nsuser/shell/zanbe36ref.in > /home/nsuser/shell/zanbe36ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe36ref.txt
