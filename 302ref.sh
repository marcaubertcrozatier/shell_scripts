...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/302_platform_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/builds/build/CBS3302PLA
...
export RECIP2="Marc.Aubert@comverse.com,Matthieu.Nguyen@comverse.com,Mark.Young@comverse.com,Harry.Schonberger@comverse.com,Linan.Su@comverse.com,Hua.Liu@comverse.com,Kenneth.Tang@comverse.com,Wendy.Guo@comverse.com,Canh.Tran@comverse.com"
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-302-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-302-*|tail -1`
...
echo "Envoi du mail"
echo
subject="Nouvelle reference 302PLATFORM : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/302ref.in > /home/nsuser/shell/302ref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/302ref.txt
...
echo "Envoi du mail"
echo
subject="New 3.0.1 PLATFORM reference : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/302ref2.in > /home/nsuser/shell/302ref2.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/302ref2.txt
############################
