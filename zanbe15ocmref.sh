...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_zanbe15_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE15OCM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-zanbe15*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-zanbe15*|sort -n -t"-" -k 6,6|tail -1`
...
sed -e "s/!NUM_REF!/$num_ref/" \
    -e "s/!VERSION!/$version/" \
< /home/nsuser/shell/zanbe15ocmref.in > /home/nsuser/shell/zanbe15ocmref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe15ocmref.txt
