...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_c-one_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/C-ONEOCM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-c-one-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-c-one-[0-9]*|sort -n -t"-" -k 8,8|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] C-ONE New OCM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/coneocmref.in > /home/nsuser/shell/coneocmref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/coneocmref.txt
