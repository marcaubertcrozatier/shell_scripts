...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/311_ocm_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/CBS33.0.15OCM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-GA3-*|sort -n -t"-" -k 7,7|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-GA3-*|sort -n -t"-" -k 7,7|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] New GA3OCM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/311refocm.in > /home/nsuser/shell/311refocm.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/311refocm.txt
...
echo "Envoi du mail"
echo
subject="New GA3 OCM reference : $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/311ref2ocm.in > /home/nsuser/shell/311ref2ocm.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/311ref2ocm.txt
############################
