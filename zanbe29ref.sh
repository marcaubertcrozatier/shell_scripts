...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/platform_zanbe29_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE29PLATFORM
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-platform-zanbe29*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-platform-zanbe29-*|sort -n -t"-" -k 6,6|tail -1`
...
< /home/nsuser/shell/zanbe29ref.in > /home/nsuser/shell/zanbe29ref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe29ref.txt
