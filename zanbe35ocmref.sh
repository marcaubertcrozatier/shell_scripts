...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_zanbe35_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/ZANBE35OCM
export REF=/space/nsuser/p4client/zanbe35/swf/css-apps
export P4CLIENT=zanbe35apps_zan
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-ocm-zanbe35*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-ocm-zanbe35*|sort -n -t"-" -k 6,6|tail -1`
...
clnum=`$P4 change -i < /home/nsuser/shell/p4specif_zanbe35ref.in|awk '{print $2}'`
...
sed -e "s/!NUM_REF!/$num_ref/" \
    -e "s/!VERSION!/$version/" \
< /home/nsuser/shell/zanbe35ocmref.in > /home/nsuser/shell/zanbe35ocmref.txt
email -s "${subject}" $RECIP2 < /home/nsuser/shell/zanbe35ocmref.txt
