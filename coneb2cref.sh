...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/b2c_c-one_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/C-ONEAPPS/myshapeb2c
...
echo;echo;echo "#######################"
cd $REFDIR
old_ref=`ls -d cbs-css-consumer-c-one-[0-9]*|tail -1`
cd $BUILDDIR
new_ref=`ls -d cbs-css-consumer-c-one-*|sort -n -t"-" -k 8,8|tail -1`
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] C-ONE New CONSUMER reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/coneb2cref.in > /home/nsuser/shell/coneb2cref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/coneb2cref.txt
