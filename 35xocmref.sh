...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/ocm_35x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/35xOCM
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 35x New OCM reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/35xocmref.in > /home/nsuser/shell/35xocmref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/35xocmref.txt
