...
#
#
export REFDIR=/home/jerusalem2/sf/cdimages/swf/builds/b2c_32x_reference
export BUILDDIR=/home/jerusalem2/sf/cdimages/swf/cdimages/build/32xAPPS/myshapeb2c
...
echo "Envoi du mail"
echo
subject="[SwF/Reference] 32x New CONSUMER reference: $num_ref"
sed -e "s/!NUM_REF!/$num_ref/" \
< /home/nsuser/shell/32xb2cref.in > /home/nsuser/shell/32xb2cref.txt
email -s "${subject}" $RECIP < /home/nsuser/shell/32xb2cref.txt
